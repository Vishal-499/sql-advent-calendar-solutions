...
SELECT l.log_id,l.break_id,cocoa_name,location_name FROM cocoa_logs l JOIN cocoa_types t ON 
  t.cocoa_id = l.cocoa_id JOIN break_schedule b 
  ON b.break_id = l.break_id JOIN 
  locations ON locations.location_id = b.location_id;
